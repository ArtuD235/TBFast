...
for run_number in run_list:
    ...
    if False:
        ...
        run_recon(config_path + config_file, runlist_path + runlist_file, "GBLAlignMimosas1", run_number)
    ...
    # Running mimosas alignment 3      
    if False:
        runlist_builder(runlist_path + runlist_file, gears[3], run_number, beam_energy, thr)
        run_recon(config_path + config_file, runlist_path + runlist_file, "patternRecognitionMimosas3", run_number)
        run_recon(config_path + config_file, runlist_path + runlist_file, "GBLAlignMimosas3", run_number)
    ...
    if False:
        ...
        runlist_builder(runlist_path + runlist_file, gears[7], run_number, beam_energy, thr)
        run_recon(config_path + config_file, runlist_path + runlist_file, "patternRecognition3", run_number)
    ...
    if False:
        ...
        runlist_builder(runlist_path + runlist_file, gears[8], run_number, beam_energy, thr)
        run_recon(config_path + config_file, runlist_path + runlist_file, "patternRecognition4", run_number)
    ...
    if False:
        ...
        runlist_builder(runlist_path + runlist_file, gears[9], run_number, beam_energy, thr)
        run_recon(config_path + config_file, runlist_path + runlist_file, "patternRecognition5", run_number)

    if False:
        last_gear = gears[9].split(".")[0] + "_last.xml"
        for i in range(1, 2):
            check_call("mv " + geometry_files_path + gears[9] + " " + geometry_files_path + last_gear, shell=True)
