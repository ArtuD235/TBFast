...
modify_config(file_config, "DEFAULT", "MaxRecordNumber", 1000000)
...
modify_config(file_config, "patternRecognition_tracks", "TripletConnectDistCut", "0.3 0.3")
modify_config(file_config, "patternRecognition_tracks", "TripletSlopeCuts", "0.006 0.006")
modify_config(file_config, "patternRecognition_tracks", "DoubletDistCut", "2 2")
modify_config(file_config, "GBLTrackFit", "r", 0.005)
modify_config(file_config, "GBLTrackFit", "dutX", 1000)
modify_config(file_config, "GBLTrackFit", "dutY", 1000)
modify_config(file_config, "GBLTrackFit", "rFEI4X", 0.08)
modify_config(file_config, "GBLTrackFit", "rFEI4Y", 0.02)
